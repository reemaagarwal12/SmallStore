...
$update="UPDATE customerdetails SET `Customer_Name`='$custname', `Phone Number`='$phno', `AmountDue`='$amtdue' where id='$id'";
mysqli_query($conn, $update) or die(mysqli_error($conn));
$status = "Record Updated Successfully. </br></br>
<a href='logview1.php'>View Updated Record</a>";
...
required value="<?php echo $row['Customer_Name'];?>" />
<br>
<br>
<input type="number" name="phno" placeholder="Enter Phone Number" 
required value="<?php echo $row['Phone Number'];?>" />
<br>
<br>
<input type="number" name="amtdue" placeholder="Enter Amount Due" 
required />
<br>
<br>
