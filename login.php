				...
				<form class="login100-form validate-form p-b-33 p-t-5" name="form1" method="POST">
					...
					<div class="container-login100-form-btn m-t-32">
						...
						<br>
						 ...
						 <a href="signup.php" style="font-size: 17px;padding-left: 45px;"> Don't have an account? Sign-up here! </a>

				</form>
			<?php
		  if(isset($found))
		  {
		  	echo '<p style="color:blue;font-size:20px;">Invalid user id or password<br>';
		  }
		  ?>
			</div>
